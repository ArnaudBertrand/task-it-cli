...
const BASE_URL = 'https://blazing-heat-4370.firebaseio.com';
...
class TodoState {
  ...
  add(text) {
    ...
    // Add task
    request.post("https://blazing-heat-4370.firebaseio.com/todos.json",
  ...
  delete(id) {
    ...
    // Delete the task
    request.del(`https://blazing-heat-4370.firebaseio.com/todos/${todo.fid}.json`);
  ...
  edit(id, attr, val){
    ...
    // Edit the task
    request.put(`https://blazing-heat-4370.firebaseio.com/todos/${todo.fid}/${attr}.json`,
